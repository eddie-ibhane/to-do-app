...
// Variables 
let LIST, id;
// Add item to localstorage (this code must added wherever the LIST array is updated)
...
// Add an item to the list user with the enter key
...
// addToDo("do something", 1, true, false);
